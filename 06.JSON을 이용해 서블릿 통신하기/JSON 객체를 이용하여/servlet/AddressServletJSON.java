	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
            ...
            while(result.next()){
				...
				person.hakbun=result.getString(1);
				person.name=result.getString(2);
				person.age=result.getInt(3);
				person.tel=result.getString(4);
				person.jumin=result.getString(5);
				person.address=result.getString(6);				
				persons.add(person);
			}
